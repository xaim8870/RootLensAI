#!/usr/bin/env python3
"""
Build the frozen processed RootLens Dataset v1 representation.

Input:
    rootlens/data/manifests/dataset_v1.yaml
...
def build_processed_dataset(
    ...
    metadata = {
        ...
        "missingness_policy": {
            ...
            "reason": (
                "Dataset v1 audit showed 98.55% of missing latency_ms and "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build frozen processed RootLens Dataset v1."
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("rootlens/data/processed/dataset_v1"),
        help="Output directory for processed Dataset v1.",
    )
...
def main() -> int:
    ...
    try:
        ...
        csv_path = output_dir / "processed_dataset_v1.csv"
        metadata_path = output_dir / "processed_dataset_v1_metadata.json"
        ...
        print()
        print("=" * 78)
        print("RootLens Processed Dataset v1 Build")
        print("=" * 78)
