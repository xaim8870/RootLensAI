#!/usr/bin/env python3
"""
Create a leakage-safe grouped train/validation/test split for RootLens Dataset v2.

Input:
    rootlens/data/processed/dataset_v2/processed_dataset_v2.csv

Output:
    rootlens/data/processed/dataset_v2/splits/
        split_definition_v2.csv
        train.csv
        validation.csv
        test.csv
        split_metadata.json
...
Expected split sizes:
    train: 24 runs / 1440 rows
    val:    8 runs /  480 rows
    test:   8 runs /  480 rows
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create grouped run-level split for RootLens Dataset v2."
    )
...
def main() -> int:
    ...
    try:
        ...
        split_definition_path = (
            output_dir / "split_definition_v2.csv"
        )
        ...
        print()
        print("=" * 78)
        print("RootLens Dataset v2 Grouped Split")
        print("=" * 78)
