#!/usr/bin/env python3
"""
Build PyTorch Geometric graph datasets for RootLens Dataset v2.
...
def get_expected_flat_feature_columns(
    ...
    """
    This must match build_processed_dataset_v2.py:
        <service>__<metric>
    """
    return [
        f"{service}__{metric}"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build PyTorch Geometric RootLens Dataset v2 graphs."
        )
    )
...
def main() -> int:
    ...
    try:
        ...
        print("=" * 86)
        print(
            "RootLens Graph Dataset v2 Build"
        )
        print("=" * 86)
